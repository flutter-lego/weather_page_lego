...
# weather_page_lego
<img src="https://github.com/user-attachments/assets/38b4a9da-b4bc-4b6b-9a3e-331dde8ea39e" width="200" alt="toss_intro_page_lego">
...
3. run the following command to generate the widget:
    ```bash
    flutter run -d chrome lib/widget_book/weather_page_lego/_/_.dart
    ```
